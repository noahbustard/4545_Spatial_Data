...
The final project can be regenerated with `run_project.py` and uses the local `src/wdo/` package for core spatial calculations. Visualization is performed with Folium to create interactive HTML maps.

## Submission Artifacts

- `run_project.py` regenerates the full analysis from the command line.
- `maps/` contains the five interactive HTML maps for each milestone.
- `screenshots/` contains static PNG previews of those maps for quick grading.
- `data/damage_zone_summary.csv` and `data/country_damage_assessment.csv` contain the final exported tables.
- `_micro_lessons/` contains the supporting Missile Geometry 101 notebook work.

## Map Previews

| Milestone | Interactive Map | Screenshot |
|---|---|---|
| 1. World map | [milestone_1_world_map.html](maps/milestone_1_world_map.html) | ![Milestone 1 world map](screenshots/milestone_1_world_map.png) |
| 2. Threat origins | [milestone_2_threats.html](maps/milestone_2_threats.html) | ![Milestone 2 threats](screenshots/milestone_2_threats.png) |
| 3. Trajectories | [milestone_3_trajectories.html](maps/milestone_3_trajectories.html) | ![Milestone 3 trajectories](screenshots/milestone_3_trajectories.png) |
| 4. Intersections | [milestone_4_intersections.html](maps/milestone_4_intersections.html) | ![Milestone 4 intersections](screenshots/milestone_4_intersections.png) |
| 5. Damage zones | [milestone_5_damage_zones.html](maps/milestone_5_damage_zones.html) | ![Milestone 5 damage zones](screenshots/milestone_5_damage_zones.png) |
...
├── screenshots/
│   ├── milestone_1_world_map.png
│   ├── milestone_2_threats.png
│   ├── milestone_3_trajectories.png
│   ├── milestone_4_intersections.png
│   └── milestone_5_damage_zones.png
├── src/
│   └── wdo/
│       ├── __init__.py
│       └── ...
...
- **`src/wdo/`**: Local helper package containing core spatial functions for Haversine distance, initial bearing, destination point, trajectory generation, and map helpers.
- **`_micro_lessons/`**: Supporting notebooks for the Missile Geometry 101 build-up work.
- **`run_project.py`**: Main reproducible project script containing the complete analysis and milestone-by-milestone output generation.
- **`README.md`**: This document.
- **`wdo_field_manual.md`**: Supporting field-manual notes for the WDO helper code.
...
1. **Prerequisites:** Ensure you have Python 3.11+ and the following packages installed:
   ...
   ```
2. **Regenerate the project outputs:** Navigate to this assignment directory and run:
   ```bash
   python3 run_project.py
   ```
3. **Inspect the generated maps:** Open the HTML files in `maps/` or use the PNG previews in `screenshots/`.

The script regenerates all five maps and the final CSV outputs.
